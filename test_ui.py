# Form implementation generated from reading ui file 'd:\STEI\Jurusan\Semester-4\Project\dashcam-detection\test.ui'
#
...
"}")
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("d:\\STEI\\Jurusan\\Semester-4\\Project\\dashcam-detection\\assets/folder_open.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
...
"}")
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("d:\\STEI\\Jurusan\\Semester-4\\Project\\dashcam-detection\\assets/play_circle.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        icon1.addPixmap(QtGui.QPixmap("d:\\STEI\\Jurusan\\Semester-4\\Project\\dashcam-detection\\assets/pause_circle_outline.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.On)
...
"}")
        ...
        self.frame_collection_left.setMaximumSize(QtCore.QSize(200, 16777215))
        ...
        self.label_blink_duration_1.setMinimumSize(QtCore.QSize(139, 0))
